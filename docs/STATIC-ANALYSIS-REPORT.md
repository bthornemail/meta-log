...
**Generated**: 2025-11-24 01:19:12

## Summary

- **Total Functions Defined**: 1042
- **Functions Called**: 702
- **Potentially Unused Functions**: 282
...
| `point-in-list` | `scheme/consciousness/geometric-propagation.scm` | 18 | internal | Internal function |
...
| `qualia-threshold` | `scheme/consciousness/qualia.scm` | 162 | internal | Internal function |
| `get-current-consciousness-state` | `scheme/consciousness/self-recognition.scm` | 57 | internal | Internal function |
| `in-closed-set` | `scheme/qstar/a-star.scm` | 175 | internal | Internal function |
| `list-sensors` | `scheme/sensors/manager.scm` | 87 | internal | Internal function |
| `list-` | `scheme/substrate/binary.scm` | 15 | internal | Internal function |
...
| `string-prefix` | `scheme/substrate/canvasl.scm` | 91 | internal | Internal function |
| `bytevector-` | `scheme/substrate/cdmp.scm` | 23 | internal | Internal function |
| `mlss-uri` | `scheme/substrate/content-address.scm` | 35 | internal | Internal function |
| `is-rule` | `scheme/substrate/prolog-interface.scm` | 125 | internal | Internal function |
| `any-output-matches` | `scheme/substrate/provenance.scm` | 81 | internal | Internal function |
